...
WINDOW_EXPORTS: dict[str, list[str]] = {
    ...
    "return_detail.html":   ["addMissingDoc", "applyExtracted", "clearDocSearch",
                             "confirmCancel", "confirmExtraction", "copyDraft",
                             "deleteDocument", "deleteFormRecord", "deleteMissingDoc",
                             "deleteReturn", "draftEmail", "extractFields",
                             "hideCancelForm", "openScanModal", "printSticker",
                             "quickToggle", "reactivateIntakeScan", "removeDependent",
                             "restartScanCountdown", "runScanAndUpload",
                             "saveContactDate", "saveContactStatus", "saveField",
                             "searchDocuments", "setStatus", "setStatusDetail",
                             "showCancelForm", "skipScanModal", "submitNote",
                             "syncDocToDrake", "toggleDocFilter",
                             "toggleExtractionReview", "toggleMissingDoc",
                             "toggleStatusMenu", "uncancelReturn", "updateDocType",
                             "_toggleExt"],
